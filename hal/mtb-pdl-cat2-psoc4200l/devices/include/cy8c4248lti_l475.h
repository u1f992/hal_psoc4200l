/***************************************************************************//**
* \file cy8c4248lti_l475.h
*
* \brief
* CY8C4248LTI-L475 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C4248LTI_L475_H_
#define _CY8C4248LTI_L475_H_

/**
* \addtogroup group_device CY8C4248LTI-L475
* \{
*/
...
typedef enum {
  ...
  /* CY8C4248LTI-L475 Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_13_IRQn      =   5,      /*!<   5 [DeepSleep] GPIO P13 (USB Wakeup) */
  ioss_interrupt_gpio_IRQn          =   6,      /*!<   6 [DeepSleep] GPIO All Ports (P5-P12 shared) */
  lpcomp_interrupt_IRQn             =   7,      /*!<   7 [DeepSleep] LPCOMP trigger interrupt */
  srss_interrupt_wdt_IRQn           =   8,      /*!<   8 [DeepSleep] WDT */
  ...
  pass_0_interrupt_ctbs_IRQn        =  13,      /*!<  13 [DeepSleep] CTBm Interrupt (all opamps) */
  cpuss_interrupt_dma_IRQn          =  14,      /*!<  14 [Active] DMA Interrupt */
  cpuss_interrupt_spcif_IRQn        =  15,      /*!<  15 [Active] SPCIF interrupt */
  srss_interrupt_lvd_IRQn           =  16,      /*!<  16 [Active] LVD */
  pass_0_interrupt_sar_IRQn         =  17,      /*!<  17 [Active] SAR ADC */
  csd_0_interrupt_IRQn              =  18,      /*!<  18 [Active] CSD #0 (CapSense) */
  csd_1_interrupt_IRQn              =  19,      /*!<  19 [Active] CSD #1 (CapSense) */
  tcpwm_interrupts_0_IRQn           =  20,      /*!<  20 [Active] TCPWM #0, Counter #0 */
  tcpwm_interrupts_1_IRQn           =  21,      /*!<  21 [Active] TCPWM #0, Counter #1 */
  tcpwm_interrupts_2_IRQn           =  22,      /*!<  22 [Active] TCPWM #0, Counter #2 */
  tcpwm_interrupts_3_IRQn           =  23,      /*!<  23 [Active] TCPWM #0, Counter #3 */
  tcpwm_interrupts_4_IRQn           =  24,      /*!<  24 [Active] TCPWM #0, Counter #4 */
  tcpwm_interrupts_5_IRQn           =  25,      /*!<  25 [Active] TCPWM #0, Counter #5 */
  tcpwm_interrupts_6_IRQn           =  26,      /*!<  26 [Active] TCPWM #0, Counter #6 */
  tcpwm_interrupts_7_IRQn           =  27,      /*!<  27 [Active] TCPWM #0, Counter #7 */
  can_0_interrupt_IRQn              =  28,      /*!<  28 [Active] CAN #0 Interrupt */
  can_1_interrupt_IRQn              =  29,      /*!<  29 [Active] CAN #1 Interrupt */
  usb_interrupt_sof_IRQn            =  30,      /*!<  30 [Active] USB SOF */
  usb_interrupt_ep_IRQn             =  31,      /*!<  31 [Active] USB EP1-EP8 */
...
#define __VTOR_PRESENT                  0       /*!< CM0 has no Vector Table Offset Register */
#define __MPU_PRESENT                   0       /*!< CM0 has no MPU */
...
/* IP List */
#define CY_IP_M0S8CPUSSV2               1u
#define CY_IP_M0S8CPUSSV2_INSTANCES     1u
#define CY_IP_M0S8CPUSSV2_VERSION       2u
#define CY_IP_M0S8CPUSSV2_DMAC          1u
#define CY_IP_M0S8CPUSSV2_DMAC_INSTANCES 1u
#define CY_IP_M0S8CPUSSV2_DMAC_VERSION  2u
#define CY_IP_M0S8CSD                   1u
#define CY_IP_M0S8CSD_INSTANCES         2u
#define CY_IP_M0S8CSD_VERSION           1u
...
#define CY_IP_MXSCB_INSTANCES           4u
#define CY_IP_MXSCB_VERSION             2u
#define CY_IP_M0S8SRSS                  1u
#define CY_IP_M0S8SRSS_INSTANCES        1u
#define CY_IP_M0S8SRSS_VERSION          1u
#define CY_IP_M0S8TCPWM                 1u
#define CY_IP_M0S8TCPWM_INSTANCES       1u
#define CY_IP_M0S8TCPWM_VERSION         2u
#define CY_IP_M0S8USBDEV                1u
#define CY_IP_M0S8USBDEV_INSTANCES      1u
#define CY_IP_M0S8USBDEV_VERSION        1u
#define CY_IP_M0S8CAN                   1u
#define CY_IP_M0S8CAN_INSTANCES         2u
#define CY_IP_M0S8CAN_VERSION           1u
#define CY_IP_M0S8WCO                   1u
#define CY_IP_M0S8WCO_INSTANCES         1u
#define CY_IP_M0S8WCO_VERSION           1u

#define CY_DEVICE_PSOC4AL
#define CY_DEVICE_SERIES_PSOC_4200L
#define CY_SILICON_ID                   0x100F11A0UL
...
#include "psoc4200l_config.h"
#include "gpio_psoc4200l_68_qfn.h"
...
#define HSIOM_PRT13                             ((HSIOM_PRT_Type*) &HSIOM->PRT[13])                               /* 0x40020D00 */

/*******************************************************************************
*                                     SRSS v2
*******************************************************************************/

#define SRSS_V2_BASE                            0x400B0000UL
#define SRSS_V2                                 ((SRSS_V2_Type*) SRSS_V2_BASE)                                    /* 0x400B0000 */
...
#define GPIO_PRT13                              ((GPIO_PRT_Type*) &GPIO->PRT[13])                                 /* 0x40040D00 */
...
#define CSD0_BASE                               0x40280000UL
#define CSD1_BASE                               0x40290000UL
#define CSD0                                    ((CSD_Type*) CSD0_BASE)                                           /* 0x40280000 */
#define CSD1                                    ((CSD_Type*) CSD1_BASE)                                           /* 0x40290000 */
...
#define USBFS0_BASE                             0x402C0000UL
#define USBFS0                                  ((USBFS_Type*) USBFS0_BASE)                                      /* 0x402C0000 */

/*******************************************************************************
*                                     CAN
*******************************************************************************/

#define CAN0_BASE                               0x402E0000UL
#define CAN1_BASE                               0x402F0000UL
#define CAN0                                    ((CAN_Type*) CAN0_BASE)                                           /* 0x402E0000 */
#define CAN1                                    ((CAN_Type*) CAN1_BASE)                                           /* 0x402F0000 */
