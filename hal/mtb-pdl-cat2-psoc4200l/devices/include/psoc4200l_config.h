/***************************************************************************//**
* \file psoc4200l_config.h
*
* \brief
* PSOC4200L device configuration header (derived from psoc4100smax_config.h)
*
********************************************************************************
* \copyright
...
#ifndef _PSOC4200L_CONFIG_H_
#define _PSOC4200L_CONFIG_H_

/* Clock Connections */
typedef enum
{
    PCLK_IMO_SPREAD                 = 0x0000u,  /* imo.spread */
    PCLK_PUMP_CLOCK                 = 0x0001u,  /* pump.clock */
    PCLK_SCB0_CLOCK                 = 0x0002u,  /* scb[0].clock */
    PCLK_SCB1_CLOCK                 = 0x0003u,  /* scb[1].clock */
    PCLK_SCB2_CLOCK                 = 0x0004u,  /* scb[2].clock */
    PCLK_SCB3_CLOCK                 = 0x0005u,  /* scb[3].clock */
    PCLK_CSD0_CLOCK0                = 0x0006u,  /* csd[0].clock0 */
    PCLK_CSD0_CLOCK1                = 0x0007u,  /* csd[0].clock1 */
    PCLK_CSD1_CLOCK0                = 0x0008u,  /* csd[1].clock0 */
    PCLK_CSD1_CLOCK1                = 0x0009u,  /* csd[1].clock1 */
    PCLK_PASS0_CLOCK_SAR            = 0x000Au,  /* pass[0].clock_sar */
    PCLK_TCPWM_CLOCKS0              = 0x000Bu,  /* tcpwm.clocks[0] */
    PCLK_TCPWM_CLOCKS1              = 0x000Cu,  /* tcpwm.clocks[1] */
    PCLK_TCPWM_CLOCKS2              = 0x000Du,  /* tcpwm.clocks[2] */
    PCLK_TCPWM_CLOCKS3              = 0x000Eu,  /* tcpwm.clocks[3] */
    PCLK_TCPWM_CLOCKS4              = 0x000Fu,  /* tcpwm.clocks[4] */
    PCLK_TCPWM_CLOCKS5              = 0x0010u,  /* tcpwm.clocks[5] */
    PCLK_TCPWM_CLOCKS6              = 0x0011u,  /* tcpwm.clocks[6] */
    PCLK_TCPWM_CLOCKS7              = 0x0012u,  /* tcpwm.clocks[7] */
    PCLK_UDB0_CLOCK                 = 0x0013u,  /* udb[0].clock */
    PCLK_UDB1_CLOCK                 = 0x0014u,  /* udb[1].clock */
    PCLK_UDB2_CLOCK                 = 0x0015u,  /* udb[2].clock */
    PCLK_UDB3_CLOCK                 = 0x0016u,  /* udb[3].clock */
    PCLK_LCD_CLOCK                  = 0x0017u,  /* lcd.clock */
    PCLK_PRGIO_CLOCK                = 0x0018u   /* prgio.clock */
} en_clk_dst_t;
...
#define CPUSS_SPCIF_SRSSLT              0u  /* PSoC 4200L uses SRSSv2, not SRSSLT */
...
#define CPUSS_SPCIF_FLASH_SIZE          1023u  /* 256KB = 1024 * 256 bytes */
...
#define IOSS_GPIO_GPIO_PORT_NR          14u  /* PSoC 4200L has ports 0-13 */
...
#define PERI_PCLK_CLOCK_NR              25u  /* PSoC 4200L has 25 peripheral clocks (0-24) */
...
/* NOTE: PSoC 4200L uses SRSSv2 (not SRSSLT). These SRSSLT_ defines are kept
   for compatibility but should not be relied upon. */
